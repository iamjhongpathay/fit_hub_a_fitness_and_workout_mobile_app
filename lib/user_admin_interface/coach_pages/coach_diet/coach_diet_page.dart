...
import 'package:fit_hub_mobile_application/user_admin_interface/coach_pages/coach_diet/coach_all_diet_details.dart';
import 'package:fit_hub_mobile_application/user_admin_interface/coach_pages/coach_diet/coach_fruits_veggies_list/coach_fruits_veggies_list_page.dart';
import 'package:fit_hub_mobile_application/user_admin_interface/coach_pages/coach_diet/coach_grains_cereals_list/coach_grains_cereals_list_page.dart';
import 'package:fit_hub_mobile_application/user_admin_interface/coach_pages/coach_diet/coach_meats_proteins_list/coach_meats_proteins_list_page.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter_offline/flutter_offline.dart';
import 'package:provider/provider.dart';

class CoachDietPage extends StatefulWidget {
  CoachDietPage ({Key key}) : super(key: key);
  @override
  _CoachDietPageState createState() => _CoachDietPageState();
}

class _CoachDietPageState extends State<CoachDietPage> {
                                          ...
                                          onTap: () {
                                            Navigator.push(context,
                                                CupertinoPageRoute(builder: (context){
                                                  return CoachMeatsProteinsListPage();
                                                })
                                            );
                                          },
                                        )
                                    ...
                                    child: ClipRRect(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () {
                                            Navigator.push(context,
                                                CupertinoPageRoute(builder: (context){
                                                  return CoachGrainsCerealsListPage();
                                                })
                                            );
                                          },
                                        )
                                    ...
                                    child: ClipRRect(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () {
                                            Navigator.push(context,
                                                CupertinoPageRoute(builder: (context){
                                                  return CoachFruitVeggiesListPage();
                                                })
                                            );
                                          },
                                        )
