...
class CoachAllDietDetails extends StatefulWidget {
  @override
  _CoachAllDietDetailsState createState() => _CoachAllDietDetailsState();
}

class _CoachAllDietDetailsState extends State<CoachAllDietDetails> {
  @override
