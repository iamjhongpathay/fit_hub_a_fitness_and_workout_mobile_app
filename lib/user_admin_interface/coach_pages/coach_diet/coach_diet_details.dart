...
class CoachDietDetails extends StatefulWidget {
  @override
  _CoachDietDetailsState createState() => _CoachDietDetailsState();
}

class _CoachDietDetailsState extends State<CoachDietDetails> {
  @override
