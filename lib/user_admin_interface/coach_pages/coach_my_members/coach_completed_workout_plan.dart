...
class CompletedWorkoutPlansPage extends StatefulWidget {
  final String uid, goal, firstName, lastName;
  const CompletedWorkoutPlansPage({Key key,
  this.uid,
    this.goal,
    this.firstName,
    this.lastName
  ...
  @override
  _CompletedWorkoutPlansPageState createState() => _CompletedWorkoutPlansPageState();
}

class _CompletedWorkoutPlansPageState extends State<CompletedWorkoutPlansPage> {
  bool isDone = true;
