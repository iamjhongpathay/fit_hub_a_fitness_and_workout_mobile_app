...
class CoachHomeBannerPage extends StatefulWidget {
  @override
  _CoachHomeBannerPageState createState() => _CoachHomeBannerPageState();
}

class _CoachHomeBannerPageState extends State<CoachHomeBannerPage> {
  @override
