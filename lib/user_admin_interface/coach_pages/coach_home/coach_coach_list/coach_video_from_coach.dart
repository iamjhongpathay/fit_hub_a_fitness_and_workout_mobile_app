...
CoachVideoFromCoach({Key key,
  ...
  @override
  _CoachVideoFromCoachState createState() => _CoachVideoFromCoachState();
}

class _CoachVideoFromCoachState extends State<CoachVideoFromCoach> {
  @override
