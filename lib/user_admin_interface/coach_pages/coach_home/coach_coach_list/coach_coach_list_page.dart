...
class CoachCoachListPage extends StatefulWidget {
  @override
  _CoachCoachListPageState createState() => _CoachCoachListPageState();
}

class _CoachCoachListPageState extends State<CoachCoachListPage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () => Navigator.of(context).pop(CoachHomePage()),
        ),
      ),
      body:  OfflineBuilder(
