...
import 'package:fit_hub_mobile_application/user_admin_interface/coach_pages/coach_home/coach_coach_videos/coach_workout_exercises_details.dart';
import 'package:flutter/material.dart';
import 'package:flutter_offline/flutter_offline.dart';
import 'package:provider/provider.dart';

class CoachCrossFitListPage extends StatefulWidget {
  @override
  _CoachCrossFitListPageState createState() => _CoachCrossFitListPageState();
}

class _CoachCrossFitListPageState extends State<CoachCrossFitListPage> {
  @override
  void initState(){
    WorkoutsExercisesNotifier workoutsExercisesNotifier = Provider.of<WorkoutsExercisesNotifier>(context, listen: false);
    getCrossFit(workoutsExercisesNotifier);
    super.initState();
  }
  @override
                                ...
                                onTap: () {
                                  ...
                                  Navigator.of(context).push(
                                      MaterialPageRoute(builder: (BuildContext context){
                                        return CoachWorkoutsExercisesDetails();
                                      })
                                  );
                                },
                              ),
