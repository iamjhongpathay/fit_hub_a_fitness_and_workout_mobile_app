...
class CoachCircuitListPage extends StatefulWidget {
  @override
  _CoachCircuitListPageState createState() => _CoachCircuitListPageState();
}

class _CoachCircuitListPageState extends State<CoachCircuitListPage> {
  @override
  void initState(){
    WorkoutsExercisesNotifier workoutsExercisesNotifier = Provider.of<WorkoutsExercisesNotifier>(context, listen: false);
    getCircuit(workoutsExercisesNotifier);
    super.initState();
  }
