...
class CoachAccountSettings extends StatefulWidget {
  @override
  _CoachAccountSettingsState createState() => _CoachAccountSettingsState();
}

class _CoachAccountSettingsState extends State<CoachAccountSettings> {
            ...
            return Scaffold(
              ...
              appBar: AppBar(
                ...
                leading: IconButton(
                  ...
                  onPressed: () => Navigator.of(context).pop(CoachAccountPage()),
                ),
              ),
              body: OfflineBuilder(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          SizedBox(height: 5.0),
                          TextFormField(
                              initialValue: _currentEmail ?? userData.email, // will disable paste operation
