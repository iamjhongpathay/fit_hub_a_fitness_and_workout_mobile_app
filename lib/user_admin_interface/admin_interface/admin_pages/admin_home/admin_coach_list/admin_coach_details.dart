...
import 'package:fit_hub_mobile_application/user_admin_interface/admin_interface/admin_pages/admin_home/admin_coach_list/admin_video_from_coach.dart';
...
class AdminCoachDetails extends StatefulWidget {
  @override
  _AdminCoachDetailsState createState() => _AdminCoachDetailsState();
}

class _AdminCoachDetailsState extends State<AdminCoachDetails> {

  @override
  Widget build(BuildContext context) {
    CoachNotifier coachNotifier = Provider.of<CoachNotifier>(context);

    _onCoachDeleted(Coach coach){
      Navigator.pop(context);
      coachNotifier.deleteCoach(coach);
      flushBar(context);
    }
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              FlatButton(
                ...
                onPressed: () {
                  deleteCoach(coachNotifier.currentCoach, _onCoachDeleted);
                  Navigator.of(context).pop();
                },
              )
            ],
                          ...
                          child: Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index){
                                ...
                                // DocumentSnapshot workoutVideos = snapshot.data.docs[index];
              ...
              onPressed: () {
                Navigator.of(context).push(
                    CupertinoPageRoute(builder: (BuildContext context){
                      return AdminCoachForm(isUpdating: true);
                    })
                );
              },
