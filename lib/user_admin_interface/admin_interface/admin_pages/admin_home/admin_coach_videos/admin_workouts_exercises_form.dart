...
class AdminWorkoutsExercisesForm extends StatefulWidget {
  final bool isUpdating;
  AdminWorkoutsExercisesForm({@required this.isUpdating});
  @override
  _AdminWorkoutsExercisesFormState createState() => _AdminWorkoutsExercisesFormState();
}

class _AdminWorkoutsExercisesFormState extends State<AdminWorkoutsExercisesForm> {
  ...
  void initState(){
    ...
    if(workoutsExercisesNotifier.currentWorkoutsExercises != null){
      _currentWorkoutsExercises = workoutsExercisesNotifier.currentWorkoutsExercises;
    } else {
  ...
  _saveWorkoutsExercises() {
    ...
    uploadWorkoutsExercisesThumbnailAndVideo(_currentWorkoutsExercises, widget.isUpdating, _thumbnailFile, _videoFile, _onWorkoutsExercisesUploaded);
