...
import 'admin_workouts_exercises_form.dart';

class AdminWorkoutsExercisesDetails extends StatefulWidget {
  @override
  _AdminWorkoutsExercisesDetailsState createState() => _AdminWorkoutsExercisesDetailsState();
}

class _AdminWorkoutsExercisesDetailsState extends State<AdminWorkoutsExercisesDetails> {
  @override
  Widget build(BuildContext context) {
    ...
    _onWorkoutsExercisesDeleted(WorkoutsExercises workoutsExercises){
      ...
      workoutsExercisesNotifier.deleteWorkoutsExercises(workoutsExercises);
      flushBar(context);
    }
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              FlatButton(
                ...
                onPressed: () {
                  deleteWorkoutsExercises(workoutsExercisesNotifier.currentWorkoutsExercises, _onWorkoutsExercisesDeleted);
                  Navigator.of(context).pop();
                },
              )
            ],
              ...
              onPressed: () {
                Navigator.of(context).push(
                    CupertinoPageRoute(builder: (BuildContext context){
                      return AdminWorkoutsExercisesForm(isUpdating: true);
                    })
                );
              },
