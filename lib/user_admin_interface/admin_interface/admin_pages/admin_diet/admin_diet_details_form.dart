...
class AdminDietDetailsForm extends StatefulWidget {
  final bool isUpdating;
  AdminDietDetailsForm({@required this.isUpdating});
  @override
  _AdminDietDetailsFormState createState() => _AdminDietDetailsFormState();
}

class _AdminDietDetailsFormState extends State<AdminDietDetailsForm> {
  ...
  void initState(){
    ...
    if(dietDetailsNotifier.currentDietDetails != null){
      _currentDietDetails = dietDetailsNotifier.currentDietDetails;
    } else {
  ...
  _saveMeatsProteins() {
    ...
    uploadMeatsProteinsThumbnailAndVideo(_currentDietDetails, widget.isUpdating, _thumbnailFile, _videoFile, _onDietDetailsUploaded);
