...
import 'admin_diet_details_form.dart';

class AdminDietDetails extends StatefulWidget {
  @override
  _AdminDietDetailsState createState() => _AdminDietDetailsState();
}

class _AdminDietDetailsState extends State<AdminDietDetails> {
  @override
  Widget build(BuildContext context) {
    ...
    _onDietDetailsDeleted(DietDetails dietDetails) {
      ...
      dietDetailsNotifier.deleteDietDetails(dietDetails);
      flushBar(context);
    }
    void _deleteDialog() {
      showDialog(
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              FlatButton(
                ...
                onPressed: () {
                  deleteDietDetails(dietDetailsNotifier.currentDietDetails, _onDietDetailsDeleted);
                  Navigator.of(context).pop();
                },
              )
            ],
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text('${dietDetailsNotifier.currentDietDetails.category.toUpperCase()}',
              ...
              onPressed: () {
                Navigator.of(context).push(
                    CupertinoPageRoute(builder: (BuildContext context){
                      return AdminDietDetailsForm(isUpdating: true);
                    })
                );
              },
