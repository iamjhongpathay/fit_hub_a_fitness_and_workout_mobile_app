...
import '../admin_diet_details.dart';

class AdminMeatsProteinsListPage extends StatefulWidget {
  @override
  _AdminMeatsProteinsListPageState createState() => _AdminMeatsProteinsListPageState();
}

class _AdminMeatsProteinsListPageState extends State<AdminMeatsProteinsListPage> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //   onPressed: () {
      //     dietDetailsNotifier.currentDietDetails = null;
      //     Navigator.push(
      //       context,
      //       MaterialPageRoute(
      //         builder: (context) => AdminDietDetailsForm(isUpdating: false),
      //       ),
      //     );
      //   },
      // ),
