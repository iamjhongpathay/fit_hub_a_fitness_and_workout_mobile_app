...
class AdminGrainsCerealsListPage extends StatefulWidget {
  @override
  _AdminGrainsCerealsListPageState createState() => _AdminGrainsCerealsListPageState();
}

class _AdminGrainsCerealsListPageState extends State<AdminGrainsCerealsListPage> {
  @override
  void initState() {
    DietDetailsNotifier dietDetailsNotifier = Provider.of<DietDetailsNotifier>(context, listen: false);
    getGrainsCereals(dietDetailsNotifier);
    super.initState();
  }
