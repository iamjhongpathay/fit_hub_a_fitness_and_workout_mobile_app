...
import 'admin_all_diet_details.dart';
import 'admin_all_diet_details_form.dart';
import 'admin_basic_nutrition_list/admin_basic_nutrition_list_page.dart';
import 'admin_fruits_veggies_list/admin_fruits_veggies_list_page.dart';
import 'admin_grains_cereals_list/admin_grains_cereals_list_page.dart';
import 'admin_meats_proteins_list/admin_meats_proteins_list_page.dart';


class AdminDietPage extends StatefulWidget {
  AdminDietPage ({Key key}) : super(key: key);
  @override
  _AdminDietPageState createState() => _AdminDietPageState();
}

class _AdminDietPageState extends State<AdminDietPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  delegate: SliverChildListDelegate(
                      [Column(
                        ...
                        children: <Widget>[
                          ...
                          //     //         return AdminBasicNutritionListPage();
                          //     //       })
                          //     //   );
                          //     // },
                          //   ),
                                          ...
                                          onTap: () {
                                            Navigator.push(context,
                                                CupertinoPageRoute(builder: (context){
                                                  return AdminMeatsProteinsListPage();
                                                })
                                            );
                                          },
                                        )
                                    ...
                                    child: ClipRRect(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () {
                                            Navigator.push(context,
                                                CupertinoPageRoute(builder: (context){
                                                  return AdminGrainsCerealsListPage();
                                                })
                                            );
                                          },
                                        )
                                    ...
                                    child: ClipRRect(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () {
                                            Navigator.push(context,
                                                CupertinoPageRoute(builder: (context){
                                                  return AdminFruitVeggiesListPage();
                                                })
                                            );
                                          },
                                        )
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          allDietDetailsNotifier.currentDietDetails = null;
          Navigator.of(context).push(
              CupertinoPageRoute(builder: (BuildContext context){
                return AdminAllDietDetailsForm(isUpdating: false);
              })
          );
        },
      ),
