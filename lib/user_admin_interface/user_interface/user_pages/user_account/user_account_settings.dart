...
import 'package:fit_hub_mobile_application/user_admin_interface/user_interface/user_pages/user_account/user_account_page.dart';
            ...
            return Scaffold(
              ...
              appBar: AppBar(
                ...
                leading: IconButton(
                  ...
                  onPressed: () => Navigator.of(context).pop(UserAccountPage()),
                ),
              ),
              body: OfflineBuilder(
