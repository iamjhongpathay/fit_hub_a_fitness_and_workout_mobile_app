...
import 'package:fit_hub_mobile_application/user_admin_interface/admin_interface/admin_pages/admin_diet/admin_diet_details.dart';
import 'package:flutter/material.dart';
import 'package:flutter_offline/flutter_offline.dart';
import 'package:provider/provider.dart';

import '../user_diet_details.dart';

class UserMeatsProteinsListPage extends StatefulWidget {
  @override
  _UserMeatsProteinsListPageState createState() => _UserMeatsProteinsListPageState();
}

class _UserMeatsProteinsListPageState extends State<UserMeatsProteinsListPage> {
  @override
  void initState() {
    DietDetailsNotifier dietDetailsNotifier = Provider.of<DietDetailsNotifier>(context, listen: false);
    getMeatsProteins(dietDetailsNotifier);
    super.initState();
  }
