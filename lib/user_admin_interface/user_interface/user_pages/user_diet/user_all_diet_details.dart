...
class UserAllDietDetails extends StatefulWidget {
  @override
  _UserAllDietDetailsState createState() => _UserAllDietDetailsState();
}

class _UserAllDietDetailsState extends State<UserAllDietDetails> {
  @override
