...
UserVideoFromCoach({Key key,
  ...
  @override
  _UserVideoFromCoachState createState() => _UserVideoFromCoachState();
}

class _UserVideoFromCoachState extends State<UserVideoFromCoach> {
  @override
