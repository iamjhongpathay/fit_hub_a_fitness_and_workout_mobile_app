...
class UserCircuitListPage extends StatefulWidget {
  @override
  _UserCircuitListPageState createState() => _UserCircuitListPageState();
}

class _UserCircuitListPageState extends State<UserCircuitListPage> {
  @override
  void initState(){
