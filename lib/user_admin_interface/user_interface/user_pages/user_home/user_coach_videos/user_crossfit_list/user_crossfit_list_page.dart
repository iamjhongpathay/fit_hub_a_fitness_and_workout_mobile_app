...
class UserCrossFitListPage extends StatefulWidget {
  @override
  _UserCrossFitListPageState createState() => _UserCrossFitListPageState();
}

class _UserCrossFitListPageState extends State<UserCrossFitListPage> {
  @override
  void initState(){
